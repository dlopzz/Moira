      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white p-8 rounded shadow w-full max-w-sm text-center">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Te enviamos un email a <strong>{form.email}</strong>. Hacé click en el link para activar tu cuenta.
          </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <FormField
              ...
              minLength={8}
            />
            <p className="text-xs text-gray-400 mt-1">Mínimo 8 caracteres, debe incluir letras y números.</p>
          </div>
          <FormField
